                ...
                <div className="modal">
                    <div style={{
                        ...
                        <div className='flex items-end justify-between modal-action gap-x-12'>
                            <div className='w-full'>
                                <div className="w-full form-control">
                                    <textarea onChange={(e)=>setNewDescription(e.target.value)} type='text' placeholder='Leave a comment here.' className="w-full h-24 pt-3 my-4 bg-black input input-lg focus:outline-none focus:border-white" />
